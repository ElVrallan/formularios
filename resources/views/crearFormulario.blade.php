...
<div class="layout-wrapper">
    ...
    <div class="form-container">
        <div class="form-banner-wrapper">
            ...
            <div class="editable-text" contenteditable="true" spellcheck="false">Nombre del formulario</div>
        </div>
        ...
        <div class="form-body">
            <form id="formularioCreate" action="{{ route('guardarFormulario') }}" method="POST">
                ...
                <div id="formFieldsContainer">
                    <!-- Respuestas se insertarán aquí -->
                </div>
                <div class="add-button-wrapper">
                    <button id="addFieldToggle" class="add-btn" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1CADE4" class="bi bi-patch-plus-fill" viewBox="0 0 16 16">
